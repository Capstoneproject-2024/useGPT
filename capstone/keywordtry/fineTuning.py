...
# 파일 업로드
# client.files.create(file=open("../../validationData.jsonl", "rb"), purpose="fine-tune")

# 미세조정 모델 만들기
# client.fine_tuning.jobs.create(
#     training_file="file-KDuklvFcJueCbT485VgzHMQp",
#     validation_file="file-1UyLmiJaG273bH4PMCzejtFW",
#     model=OPENAI_MODEL,
# )
